    ...
    case Guardian.decode_and_verify(old_token) do
      {:ok, claims} ->
        case Guardian.resource_from_claims(claims) do
          ...
          {:error, _reason} -> raise ErrorResponse.NotFound, message: "Account not found."
        end
      {:error, _reason} -> raise ErrorResponse.NotFound, message: "Token not found."
    end
  end
